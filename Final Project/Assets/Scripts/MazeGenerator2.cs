...
public class MazeGenerator2 : MonoBehaviour
{
    ...
    public void CreateLayout2()
    {
        ...
        GameObject.Find("Maze2").transform.position = (Vector2)transform.position + BGoffSet;
        Vector2 startPos = GameObject.Find("Maze2").transform.position;
    ...
    public void MakeExit()
    {
        ...
        GameObject.Find("Maze2").transform.Rotate(90, 0, 0);
        GameObject.Find("Maze2").transform.position = new Vector3(0f, 0f, 15.367f);
    ...
    public void InitValues()
    {
        ...
        mazeParent = GameObject.Find("Maze2");
